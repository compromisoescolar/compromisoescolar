    ...
    <body style="background: #BDC3C7; padding: 0;">
        ...
        <div class="contenido row justify-content-center align-items-center">
            <div class="card_c" style="background: white; ">
                ...
                <br><br><br><br><br>
                <div class="arriba">
                     <h1 id="c_tit" style="line-height: 45px !important;">
                        ¡Error, página no encontrada!
                        <hr id="tit">
                     </h1>
                    <p style="text-align: justify; font: condensed 100% Source Sans Pro; color: #212529; font-size: larger;">
                        Lo sentimos pero no hemos encontrado la página que estabas buscando, por favor vuelve al <a href="https://www.compromisoescolar.com">inicio</a>. 
                        <br><br>
                    </p>
                </div>
                <div class="abajo">
